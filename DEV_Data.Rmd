...
#  mutate(dummy_drought_consecutive = case_when(
#      district_name %in% c("Gegharkunik", "Shirak", "Syunik") ~ 0,
#      year >= 2017 ~ 1,
#      TRUE ~ dummy_drought_consecutive))
...
## By District
```{r district desc ev income, message=FALSE, warning=FALSE}
...
```{r district desc ev agric prod, message=FALSE, warning=FALSE}
...
```
```{r district desc ev income drought, message=FALSE, warning=FALSE}
...
```{r district desc ev agric prod drought, message=FALSE, warning=FALSE}
...
```{r district desc ev w/ deciles w/ agri, message=FALSE, warning=FALSE}
# A2. Create the plot d
