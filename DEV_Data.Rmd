...
# In some dataset, the variable is called y1_3drm.10, but on other it is called 
# differently. But on some y1_3drm.10 exists and is related to another variable.
# We thus need to change the name of those variable
...
# Change settlement values for a dummy variable (urbanziation)
hh_dataset <- hh_dataset %>%
...
# Graph 1: Poverty trend over time, faceted by district
