...
colnames(dataset)[colnames(dataset) == "Gross harvest of grape"] <- 'grape_harvest'
colnames(dataset)[colnames(dataset) == "Gross harvest of vegetables"] <- 'vegetable_harvest'
...
colnames(dataset)[colnames(dataset) == "Planting areas of grapes"] <- 'grapes_area'


# Add all crop-related agricultural output variables
dataset$crops_output = dataset$potatoes_harvest + dataset$fruits_harvest + dataset$grains_harvest + dataset$vegetable_harvest
